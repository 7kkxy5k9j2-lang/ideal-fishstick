    ...
    ***************************************************************************** */
            ...
            function mutate(_a) {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    if (type === 'deleteRange') {
                        ...
                        var _a = isAddOrPut ?
                            outbound ? [values, keys] : [values, null] : [keys, null],
                            args1 = _a[0],
                            args2 = _a[1];
                        if (isAddOrPut) {
                            for (var i = 0; i < length; ++i) {
    ...
    function _onDatabaseCreated(_a, name) {
        ...
        !hasDatabasesNative(indexedDB) &&
            name !== DBNAMES_DB &&
            getDbNamesTable(indexedDB, IDBKeyRange).put({
                name: name
            }).catch(nop);
    }
                                ...
                                if (!queriedIndex.isPrimaryKey) {
                                    if (method === "count") {
                                        ...
                                        var keysPromise_1 = method === "query" &&
                                            outbound &&
                                            req.values &&
                                            table.query(__assign(__assign({}, req), {
                                                values: false
                                            }));
